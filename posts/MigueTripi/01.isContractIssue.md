...
As I mentioned at the beginning, this issue was discussed several times during last year resulting in the remotion of `isContract()` method on OZ version 5.0. But be careful because this method will be marked as deprecated (but able to use) on previous versions.
