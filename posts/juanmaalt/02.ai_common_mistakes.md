...
published: false
description: Seven mistakes backend engineers commonly make when integrating LLMs into production systems, and how to avoid them.
...
Here, I will try to cover seven common mistakes that I've seen (and made).
...
## 4. Treating prompt engineering as someone else's problem
...
## 5. Trusting free-form text when you don’t have to
...
## 6. Putting everything in the context window and calling it RAG
...
## 7. Not thinking about what happens when the model is wrong
