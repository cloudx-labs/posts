...
> This implementation focuses on using specifics services and functionalities provided by AWS services. Implementations will vary depending on the provider (Azure, GCP).
